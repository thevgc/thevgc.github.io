...
import { Vec2, Vec3 } from "@/helpers/color";
...
const LIGHT_DIR = new Vector3(0.0, 1.0, -1.0).normalize();
    ...
    loadAssets() {
      ...
      loader.load({
        text: [
          {
            name: "grass.vert",
            url: require("@/assets/shaders/grass.vert.glsl")
          },
          {
            name: "grass.frag",
            url: require("@/assets/shaders/grass.frag.glsl")
          },
          {
            name: "terrain.vert",
            url: require("@/assets/shaders/terrain.vert.glsl")
          },
          {
            name: "terrain.frag",
            url: require("@/assets/shaders/terrain.frag.glsl")
          },
          {
            name: "water.vert",
            url: require("@/assets/shaders/water.vert.glsl")
          },
          {
            name: "water.frag",
            url: require("@/assets/shaders/water.frag.glsl")
          }
        ],
        images: [
