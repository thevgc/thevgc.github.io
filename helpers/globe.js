...
var Globe = function Globe(container, urls) {
  ...
  api.init = function() {
    ...
    scene.add(new THREE.AmbientLight(0xffffff, 1));
      ...
      //directional.position.x = position.x;
      light.position.set(0, 1, 0);

    scene.add(light);
				let directionalLight = new THREE.DirectionalLight(0x007cba);
        directionalLight.position.set(0, 70, 100).normalize();
        setTimeout(function() {
          scene.add(directionalLight);
        }, 500);
				let pointLight = new THREE.PointLight(0x007cba);
  ...
  var createMesh = {
    ...
    earth: function(urls) {
      ...
      uniforms["texture"].value = loader.load(urls.earth);
      ...
      let mesh = new THREE.Mesh(earthGeometry, material);
...
// return new THREE.Mesh(earthGeometry, material);
    ...
    directionalLight: function() {
      let directional = new THREE.DirectionalLight(0xcccccc, 0.5);
